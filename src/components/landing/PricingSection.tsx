export default function PricingSection(props) {
  ...
  const data_pricing = [
    {
      ...
      link: "https://aribudin.gumroad.com/l/reactdash?wanted=true&variant=Single%20License",
    },
    {
      name: "Multiple",
      price: "83",
      currency: "$",
      features1: "Unlimited Products",
      features2: "Personal or client",
      features3: "Lifetime Update",
      features4: "Supports 24/7",
      features5: "Build Saas Business",
      features6: "Can't for generators",
      link: "https://aribudin.gumroad.com/l/reactdash?wanted=true&variant=Multiple%20License",
    },
  ];
  ...
  return (
    <div
      id="pricings"
      className="relative py-14 md:py-16 bg-white dark:bg-gray-800"
    >
        ...
        <div className="flex flex-wrap flex-row -mx-4 justify-center">
          {data_pricing.map((pricing, index) => {
            const bg_pricing = pricing.features7
              ...
              : "bg-white dark:bg-gray-900 dark:bg-opacity-20 border border-gray-200 dark:border-gray-700";
            return (
              <div
                key={index}
                ...
                <div className="px-6 md:px-2 lg:px-4">
                  ...
                  >
                    ...
                    <ul className="space-y-6 mt-4 mb-12">
                      {pricing.features1 ? <li>{pricing.features1}</li> : ""}
                      {pricing.features2 ? <li>{pricing.features2}</li> : ""}
                      {pricing.features3 ? <li>{pricing.features3}</li> : ""}
                      {pricing.features4 ? <li>{pricing.features4}</li> : ""}
                      {pricing.features5 ? <li>{pricing.features5}</li> : ""}
                      {pricing.features6 ? <li>{pricing.features6}</li> : ""}
                    </ul>
