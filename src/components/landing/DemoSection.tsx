...
export default function DemoSection(props) {
  const demos = {
    ...
    description: "Check out our various dashboard examples.",
  };
  ...
  const data_demos = [
    {
      title: "Cms Dashboard",
      url: "/dashboard/cms",
      img: "/img/demo/react-dashboard-sales.jpg",
    },
    {
      title: "Analytics Dashboard",
      url: "/dashboard/analytics",
      img: "/img/demo/react-dashboard-analytics.jpg",
    },
    {
      title: "Ecommerce Dashboard",
      url: "/dashboard/ecommerce",
      img: "/img/demo/react-dashboard-ecommerce.jpg",
    },
    {
      title: "Project Dashboard",
      url: "/dashboard/projects",
      img: "/img/demo/react-dashboard-project.jpg",
    },
    {
      title: "Crm Dashboard",
      url: "/dashboard/crm",
      img: "/img/demo/react-dashboard-crm.jpg",
    },
    {
      title: "Hosting Dashboard",
      url: "/dashboard/hosting",
      img: "/img/demo/react-dashboard-hosting.jpg",
    },
    {
      title: "Saas Dashboard",
      url: "/dashboard/saas",
      img: "/img/demo/react-dashboard-saas.jpg",
    },
    {
    ...
    },
    {
      ...
      img: "/img/demo/react-dashboard-marketing.jpg",
    },
  ];
