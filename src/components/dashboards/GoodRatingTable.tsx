...
import { ProductGoodRating } from "@/layouts/dashboard/GoodRating";
...
type DataGoodRatingTable = {
  currentPage: number;
  products: ProductGoodRating[];
  perPage: number;
};

export default function GoodRatingTable(props: ReturnRateTableProps) {
  const [state, setState] = useSetState<DataGoodRatingTable>({
    currentPage: 1,
    products: [],
    perPage: 8,
  });
