...
import { ProductReturnRate } from "@/layouts/dashboard/ReturnedRate";
...
type DataReturnRateTable = {
  currentPage: number;
  products: ProductReturnRate[];
  perPage: number;
};

export default function ReturnedRateTable(props: ReturnRateTableProps) {
  const [state, setState] = useSetState<DataReturnRateTable>({
    currentPage: 1,
    products: [],
    perPage: 8,
  });
