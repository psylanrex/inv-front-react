  ...
  const data1 = {
    ...
    datasets: [
      ...
      },
      {
        ...
        backgroundColor: [hexToRGBA(text_primary_500, 0.8)],
      },
      {
        label: "Refferal",
            ...
            <Tab as="li" key="1" className="ltr:mr-1 rtl:ml-1">
              {({ selected }) => (
                <button
                  className={
                    selected
                      ? "block sm:inline-block py-4 px-2 md:px-6 lg:px-8 focus:outline-none focus:ring-0 font-semibold -mb-px bg-white dark:bg-gray-800"
                      : "block sm:inline-block py-4 px-2 md:px-6 lg:px-8 focus:outline-none focus:ring-0 font-semibold"
                  }
                >
