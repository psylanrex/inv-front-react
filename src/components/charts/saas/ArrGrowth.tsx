    ...
    datasets: [
      {
        ...
        yAxisID: "A",
        data: [
          1040, 1120, 1140, 1120, 1240, 4120, 5780, 6210, 7300, 9600, 12700,
          27900,
        ],
      ...
      },
      {
        ...
        yAxisID: "A",
        data: [
          15540, 14540, 15840, 15940, 15540, 11250, 10380, 9210, 9100, 8610,
          8150, 6010,
        ],
    ...
    datasets: [
      {
        ...
        yAxisID: "A",
        data: [
          1140, 1320, 1340, 1520, 1540, 4220, 4780, 5210, 6300, 8600, 11700,
          17900,
        ],
        borderColor: text_primary_500,
        backgroundColor: [text_primary_500],
      ...
      },
      {
        ...
        yAxisID: "A",
        data: [
          11540, 11540, 11840, 15940, 18540, 18250, 13380, 19210, 19100, 18610,
          18150, 16010,
        ],
        borderColor: text_secondary_500,
        backgroundColor: [text_secondary_500],
