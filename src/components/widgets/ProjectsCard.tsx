...
export default function ProjectsCard() {
  ...
  const projects = [
    ...
    {
      name: "Web Apps and PWA",
      img: "/img/brand/brand3.jpg",
      description:
        "Creating a website redesign project plan is vital to making your redesign go smoothly.There’s who you think your customers are, who you want your customers to be.",
      progress: "On Progress",
      due: "15-11-2022",
              ...
              <div className="flex justify-between mt-3">
                ...
                <div>
                  {tasks.map((task, index) => (
                    <span
                      key={index}
                      className="px-2 py-1 text-xs rounded font-semibold mr-2 bg-gray-100 text-gray-700"
                    >
                      {task.name}
                    </span>
                  ))}
