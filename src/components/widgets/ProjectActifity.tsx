    ...
    actifities: [
      {
        ...
        date: "Aug 26, 2025 03.21 am",
        status: "Assigned task",
        task: "Create landing page design with Figma",
      },
      {
        name: "Carlos Garcia",
        ...
        date: "Aug 26, 2025 03.21 am",
        status: "Completed",
        task: "Convert Figma footer design to HTML file",
      },
      {
        name: "John Doe",
        ...
        date: "Aug 26, 2025 03.21 am",
        status: "Completed",
        task: "Fix bugs on Login page form",
      },
      {
        ...
        date: "Aug 26, 2025 03.21 am",
        status: "Assigned task",
        task: "Fix bugs on Comments form",
      },
      {
        name: "Carlos Garcia",
            ...
            <li key={index} className="flex mb-2">
              <div className="relative flex-shrink-0 w-12 text-center">
                ...
                <div className="mr-auto">
                  <img
                    src={list.img}
                    className="h-10 w-10 rounded-full border border-gray-300 bg-gray-700 dark:border-gray-200 dark:bg-gray-200"
                  />
                </div>
              </div>
              ...
              <div className="w-full ml-4 mb-4">
                ...
                <p className="text-sm">
                  {list.status}{" "}
                  <span className="itaic font-semibold text-gray-500">
                    "{list.task}"
                  </span>
                </p>
              </div>
