    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg h-full p-6">
      ...
      <div className="py-3">
        ...
        <div className="ltr:text-left rtl:text-right">
          <p className="mb-2">
            <strong>{profile_text.name} :</strong>
            <span className="ml-2">{profile.name}</span>
          </p>
          <p className="mb-2">
            <strong>{profile_text.phone} :</strong>
            <span className="ml-2">{profile.phone}</span>
          </p>
          <p className="mb-2">
            <strong>{profile_text.email} :</strong>
            <span className="ml-2">{profile.email}</span>
          </p>
          <p className="mb-2">
            <strong>{profile_text.location} :</strong>
            <span className="ml-2">{profile.location}</span>
          </p>
          <p className="mb-2">
            <strong>{profile_text.language} :</strong>
