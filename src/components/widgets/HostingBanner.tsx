...
export default function HostingBanner(props) {
  // props data
  const banner = {
    title: "Upgrade your Hosting<br /> with Cloud Server!",
    description:
      "Very simple to upgrade your hosting package with Cloud Server. Discount 30% for first year subscription.",
    url: "/",
    btn: "Upgrade now",
  };
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg px-8 py-6 relative overflow-hidden">
      ...
      <div className="relative">
        <h4 className="font-bold text-gray-800 dark:text-gray-200 text-2xl mb-3">
          {parse(banner.title)}
        </h4>
