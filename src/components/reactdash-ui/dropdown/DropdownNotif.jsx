...
export default function DropdownNotif(props) {
  ...
  return (
    <Menu>
      <Menu.Button className="py-3 px-4 flex text-sm rounded-full focus:outline-none" id="user-menu-button">
      ...
      <Transition 
        ...
        >
        <Menu.Items as="div" className="w-72 transform translate-x-16 lg:translate-x-0 origin-top-right absolute ltr:right-0 rtl:left-0 rounded top-full z-50 py-0.5 ltr:text-left rtl:text-right bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md">
          {/* Head notification */}
