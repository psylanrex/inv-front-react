...
export default function BestSeller(props) {
  ...
  const data_table = [
    {
      title: "Nike Women's Race Running Shoe",
    ...
    {
      title: "Nike Womens Free RN Flyknit 2023",
    ...
    {
      title: "Nike Men's Sneaker Running Shoes",
    ...
    {
      title: "Adidas World cup limited edition",
    ...
    {
      title: "Adidas Ronaldo Limited Edition",
