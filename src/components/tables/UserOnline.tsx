    ...
    <>
      <Card className="!p-0 h-full">
        <div className="pt-6 px-6 relative">
          {title.text}{" "}
          <span className="ltr:float-right rtl:float-left w-2 h-2 rounded-full bg-green-500 mt-1 animate-pulse"></span>
        </div>
        ...
        <div className="p-6">
          <a className="hover:text-indigo-500" href={footer_link.url}>
            {footer_link.text}
          </a>
        </div>
      </Card>
