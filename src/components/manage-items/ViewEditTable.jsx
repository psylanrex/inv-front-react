...
export default function ViewEditTable(props) {
    // data text
    const action_text = {
        add: "Add New",
        status: "Status",
    ...
    // data table
    const table_title = { id: "Item Code", name: "Name", status: "Status", price: "Price", action: "Action" }
    const data_table = [
                    ...
                    {currentData.map((order, id) => {
                        ...
                        return (
                            <tr key={id}>
                                ...
                                <td>
                                    <div className="leading-5">{order.price}</div>
                                </td>
                                <td>
                                ...
                                <td className="text-center">
                                    <a href={order.url}>
                                        <Button color="light" size="small">
                                            <XSquare className="inline text-red-500" />
                                        </Button>
                                    </a>
                                </td>
                            </tr>
