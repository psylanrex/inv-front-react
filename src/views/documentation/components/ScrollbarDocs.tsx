        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              A scrollbar is an interaction technique or widget in which
              continuous text, pictures, or any other content can be scrolled in
            ...
            <p className="mb-6">
              Just add <code className="text-pink-500">scrollbars show</code> or{" "}
              <code className="text-pink-500">scrollbars</code> in{" "}
              <code className="text-pink-500">overflow-y-auto</code> classes.
            </p>
