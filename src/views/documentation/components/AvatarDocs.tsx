        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              An example of a simple avatar component for your React app.
            </p>
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-300">
              Shape
            </h2>
            <p className="mb-4 font-light">
              There are 3 choices of avatar 'shape' circle, rounded and square.
            ...
            <p className="mb-4 font-light">
              There are 4 choices of avatar 'size' x-small, small, medium and
            ...
            <Card className="relative p-6 border border-gray-200 dark:border-gray-700 shadow-none">
              ...
              <Avatar
                data={data_avatar}
                className="!w-24 !h-24 !rounded-t-xl !rounded-b-none"
              />
            </Card>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <code>'circle'</code> | <code>'rounded'</code> |{" "}
                    <code>'square'</code>
                  </td>
                  <td>
                    <code>'circle'</code>
                ...
                <tr>
                  ...
                  <td>Avatar size</td>
                  <td>
                    <code>'x-small'</code> | <code>'small'</code> |{" "}
                ...
                <tr>
                  ...
                  <td>Data avatar</td>
                  <td>
                    data ( <code>img</code> | <code>name</code> )
                  </td>
                  <td>
                    <code>-</code>
                  </td>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <code>custom count like</code> <code>'4'</code> or{" "}
                    <code>'6'</code>
                  </td>
                  <td>
                    <code>'5'</code>
                ...
                <tr>
                  ...
                  <td>Data avatar</td>
                  <td>
                    data ( <code>id</code> | <code>img</code> |{" "}
