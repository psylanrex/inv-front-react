        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              Documentation and examples for using custom progress bars
              featuring support for stacked bars and text labels.
            </p>
            ...
            <h2 className="text-lg mt-6 mb-2 font-semibold text-gray-800 dark:text-gray-300">
              Circle Progress
            </h2>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <code>'horizontal' | 'vertical' | 'circle'</code>
                  </td>
                  <td>
