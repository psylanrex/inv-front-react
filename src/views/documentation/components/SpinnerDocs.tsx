    ...
    <Preloader>
        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            ...
            <p className="mb-4 font-light">
              There are 2 choices of spinner 'model' spin and ping. The default
              model is spin.
            </p>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Spinner size</td>
                  <td>
                    <code>'x-small' | 'small' | 'medium' | 'large'</code>
                  </td>
                  <td>
                    <code>'medium'</code>
                  </td>
      ...
      <Row>
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              Preloader is the what you see on some sites before the main
              content of the web page is loaded.
            </p>
            <h2 className="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">
              preloader
            </h2>
