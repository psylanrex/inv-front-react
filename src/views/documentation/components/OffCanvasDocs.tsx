...
export default function OffCanvasDocs() {
  ...
  const content = {
    logo: "/img/logo.png",
    text: "Copyright Taildash - All right reserved",
  };
  const list_menu = [
        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              ...
              carts, and more with a few classes and React Hook.
            </p>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Data listmenu</td>
                  <td>
                    data ( <code>id</code> | <code>title</code> |{" "}
                    <code>url</code> )
                  </td>
                  <td>
                    <code>-</code>
            ...
            <Card className="relative p-6 border border-gray-200 dark:border-gray-700 shadow-none mb-6">
              <OffCanvas placement="left">
                <div className="p-6 text-center">
                  <Avatar data={data_avatar} size="small" />
                  <h3 className="heading-6 mt-4 mb-6 font-bold">
                    {data_avatar.name}
                  </h3>
                  <ListGroup
                    data={data_list}
