        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              ...
              classes and Headless UI.
            </p>
            <h2 className="text-lg mb-2 font-semibold text-gray-800 dark:text-gray-300">
              Title and color
            </h2>
            <p className="mb-4 font-light">
              In Collapse 'title' is used to change button text and 'color' to
              change button color. For content, you can immediately enter
              anything in collapse such as images, custom html and text.
            </p>
            <Card className="relative p-6 border border-gray-200 dark:border-gray-700 shadow-none">
              <Collapse
                title={title_collapse1}
                color="success"
                className="mb-4"
              >
                <p>
                  Placeholder content for the tab panel. This one relates to the
                  home tab. Takes you miles high, so high, cause she got that
      ...
      <Row>
        <Column className="w-full px-4">
          <Card className="relative p-6">
            ...
            <p className="mb-4 font-light">
              In Collapse 'data' is used to change questions and answers.
            </p>
            <Card className="relative p-6 border border-gray-200 dark:border-gray-700 shadow-none">
              <FaqCollapse data={faqitem} />
            </Card>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    data (<code>question | answer</code>)
                  </td>
                  <td>
                    <code>-</code>
                  </td>
