        ...
        <Column className="w-full px-4">
          <Card className="relative p-6">
            <p className="text-lg mb-6 font-light">
              The easiest way to wrap your screenshots on Iphone and Macbook.
              Make screenshots for Iphone with size 375x812 and for macbook size
              500x800.
            </p>
            ...
            <p className="mb-4 font-light">
              There are 2 choices of device 'variant' iphone and macbook. The
              default variant is iphone.
            </p>
            ...
            <table className="table-default mb-12">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <code>'iphone'</code> | <code>'macbook'</code>
                  </td>
                  <td>
                    <code>'iphone'</code>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <code>iphone size = 375x812 </code> |{" "}
                    <code>macbook size = 500x800</code>
                  </td>
                  <td>
                    <code>-</code>
                  </td>
