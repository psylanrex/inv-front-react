...
export default function Maintenance() {
  const data_main = {
    ...
    description:
      "We're making the system more awesome. We'll be back shortly. If you have any questions, please contact us.",
    img: "/img/ilustration/maintenance.png",
    alt: "Maintenance",
    phone: "(+123) 456 7890",
  ...
  return (
    <div className="min-h-screen font-sans text-base font-normal text-gray-600 dark:text-gray-400 pt-20 bg-indigo-600 bg-gradient-to-r from-indigo-800 via-indigo-700 to-green-500 dark:from-gray-800 dark:via-gray-700 dark:to-green-700">
          ...
          <div className="container mx-auto px-4 xl:max-w-6xl py-2">
            <div className="flex flex-row justify-between py-6">
              ...
              <div className="flex items-center">
                <p className="self-center font-bold text-white pr-8">
                  {data_main.phone}
                </p>
              </div>
            </div>
      ...
      <main id="content">
        <div
          id="hero"
          className="relative z-0 py-12 lg:py-20 text-gray-300 overflow-hidden"
        >
            ...
            <div className="flex flex-wrap flex-row -mx-4 justify-center">
              <div className="flex-shrink max-w-full px-4 w-full md:w-9/12 lg:w-1/2 self-center lg:pr-12">
                <div className="text-center lg:ltr:text-left lg:rtl:text-right mt-6 lg:mt-0">
                  ...
                  <a
                    href={data_main.contact_link}
                    className="py-2 px-4 inline-block text-center rounded leading-5 text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0 mr-4"
                  >
                    {data_main.contact}
                  </a>
                </div>
