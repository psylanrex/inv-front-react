// Index admin views
import Cms from "@/views/dashboard/Cms";
...
import Hosting from "@/views/dashboard/Hosting";
...
export { Cms, Crm, Analytics, Sales, Hosting, Saas, Marketing, Ecommerce, Projects }