...
export default function Faq() {
  const faq_title = {
    ...
    description: "Most Popular Question from New Client!",
  };
  const data_faqs = [
    {
      title: "How is the SEO services system at One Company?",
      description:
        "Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.",
    },
    {
      title: "How many keywords are optimized?",
      description:
        "Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.",
    },
    {
    ...
    {
      title: "What is the rate if I type in a credit card?",
      description:
        "Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.",
    },
  ];
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap flex-row -mx-4">
                {data_faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="flex-shrink max-w-full px-4 w-full lg:w-1/2"
                  >
                    <div className="p-6 bg-white dark:bg-gray-800">
                      <h3 className="text-lg leading-normal mb-2 font-semibold dark:text-gray-300">
                        <QuestionCircle className="text-indigo-500 ltr:mr-2 rtl:ml-2 inline-block" />
                        {faq.title}
                      </h3>
