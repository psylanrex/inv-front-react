...
import { CurrencyDollar, Folder, Receipt, Box, Stopwatch } from 'react-bootstrap-icons';
            ...
            <Preloader>
                ...
                <Row>
                    <Column className="w-full px-4">
                        <Heading variant="h4" className="text-indigo-500 bg-indigo-100 text-center py-4 rounded-lg">
                            Purchasing Stats
                        </Heading>
                    </Column>
